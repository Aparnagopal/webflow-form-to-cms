...
export declare namespace ComponentDomWriteNodesItem {
    type Raw = TextNodeWrite.Raw | ComponentInstanceNodePropertyOverridesWrite.Raw | SelectNodeWrite.Raw | TextInputNodeWrite.Raw | SubmitButtonNodeWrite.Raw | SearchButtonNodeWrite.Raw;
}
